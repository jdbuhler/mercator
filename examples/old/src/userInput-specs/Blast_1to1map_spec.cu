...
/***  App name ***/
#pragma mtr application BlastApp_1to1map<BlastData>
...
#pragma mtr module SmallExt (point[128] -> outStream<point>:?1 | 1 : 1) 
#pragma mtr module UngapExt (point[128] -> outStream<point>:?1 | 1 : 1) 
