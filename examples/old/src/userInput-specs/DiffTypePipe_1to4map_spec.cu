/**
  ...
  *           End: finish node
  *
  * Mapping: 1:4 from elements to threads; i.e., 4 threads
...
/*** App name. ***/
#pragma mtr application DiffTypePipe_1to4map
...
#pragma mtr module A (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 4) 

#pragma mtr module B (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 4) 

#pragma mtr module C (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 4) 

#pragma mtr module D (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 4) 

#pragma mtr module E (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 4) 
