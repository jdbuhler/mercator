...
/*** App name. ***/
#pragma mtr application DiffTypePipe_1to2map
...
#pragma mtr module A (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 2) 

#pragma mtr module B (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 2) 

#pragma mtr module C (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 2) 

#pragma mtr module D (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 2) 

#pragma mtr module E (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 2) 
