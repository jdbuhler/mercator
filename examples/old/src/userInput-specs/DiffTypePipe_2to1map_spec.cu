...
/*** App name. ***/
#pragma mtr application DiffTypePipe_2to1map
...
#pragma mtr module B (PipeEltT[256] -> accept<PipeEltT>:?1 | 2 : 1) 

#pragma mtr module C (PipeEltT[256] -> accept<PipeEltT>:?1 | 2 : 1) 

#pragma mtr module D (PipeEltT[256] -> accept<PipeEltT>:?1 | 2 : 1) 

#pragma mtr module E (PipeEltT[256] -> accept<PipeEltT>:?1 | 2 : 1) 
