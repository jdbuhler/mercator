...
/*** App name. ***/
#pragma mtr application Rep4DiffPipe_1to1map
...
#pragma mtr module A3 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module B3 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module C3 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module D3 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module E3 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module End3 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1)  
#pragma mtr module A4 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module B4 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module C4 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module D4 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module E4 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1) 

#pragma mtr module End4 (PipeEltT[128] -> accept<PipeEltT>:?1 | 1 : 1)
...
//rep 3
#pragma mtr node A3node<NodeDataT> : A3
#pragma mtr node B3node<NodeDataT> : B3
#pragma mtr node C3node<NodeDataT> : C3
#pragma mtr node D3node<NodeDataT> : D3
#pragma mtr node E3node<NodeDataT> : E3
#pragma mtr node EndNode3 : End3
#pragma mtr node sinkNodeAccept3 : SINK<PipeEltT>
//rep 4
#pragma mtr node A4node<NodeDataT> : A4
#pragma mtr node B4node<NodeDataT> : B4
#pragma mtr node C4node<NodeDataT> : C4
#pragma mtr node D4node<NodeDataT> : D4
#pragma mtr node E4node<NodeDataT> : E4
#pragma mtr node EndNode4 : End4
