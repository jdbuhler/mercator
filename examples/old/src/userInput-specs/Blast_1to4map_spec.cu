/**
  ...
  *
  * Mapping: 1 elt per 4 threads.
  */

#include "datatypes.h"

/***  App name ***/
#pragma mtr application BlastApp_1to4map<BlastData>
...
#pragma mtr module SeedMatch (int[128] -> outStream<point>:?1 | 1 : 4) 
//#pragma mtr module SeedEnum (point[512] -> outStream<point>:?16 | 1 : 1) 
#pragma mtr module SeedEnum (point[128] -> outStream<point>:?16 | 1 : 4) 
#pragma mtr module SmallExt (point[2048] -> outStream<point>:?1 | 1 : 4) 
#pragma mtr module UngapExt (point[2048] -> outStream<point>:?1 | 1 : 4) 
