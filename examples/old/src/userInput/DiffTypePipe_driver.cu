#ifndef __DIFFTYPEPIPE_DRIVER_CU
#define __DIFFTYPEPIPE_DRIVER_CU
...
//#include "../codegenInput/DiffTypePipe.cuh"

#if MAPPING_1TO1
  #include "../codegenInput/DiffTypePipe_1to1map.cuh"
  #define APP_TYPE DiffTypePipe_1to1map
#elif MAPPING_1TO2
...
#define PRINT_INPUT_BUFFER_DIFFTYPEPIPE 0
#define PRINT_OUTPUT_BUFFERS_DIFFTYPEPIPE 0
...
void run_diffTypePipe()
{
...
#if PRINT_INPUT_BUFFER_DIFFTYPEPIPE 
  ...
  // create app object
  APP_TYPE* diffTypePipe = new APP_TYPE();
...
//    printf("Setting upper bound of node %d to %d\n", i, upperBd);
  ...
  diffTypePipe->A->set_nodeUserData(APP_TYPE::A::Node::Anode, myNodeData[0]);
  diffTypePipe->B->set_nodeUserData(APP_TYPE::B::Node::Bnode, myNodeData[1]);
  diffTypePipe->C->set_nodeUserData(APP_TYPE::C::Node::Cnode, myNodeData[2]);
  diffTypePipe->D->set_nodeUserData(APP_TYPE::D::Node::Dnode, myNodeData[3]);
  diffTypePipe->E->set_nodeUserData(APP_TYPE::E::Node::Enode, myNodeData[4]);
  ...
  std::cout << "DIFF-TYPE-PIPE APP FINISHED. Num results: "
  ...
  printf("Diff-type-pipe, OutBufferAccept (%p):\n", outBufferAccept);
